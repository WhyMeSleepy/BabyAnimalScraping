...
def lottery_number(page):
    ...
    for lottery in lotteries:
        ...
        writer.writerow([date,firstPrize,firstThree,lastThree,lastTwo])
...
if __name__ == '__main__':
    ...
    writer.writerow(['DrawDate','FirstPrize','FirstThree DigitsPrize','LastThreeDigitsPrize','LastTwoDigitsPrize'])
